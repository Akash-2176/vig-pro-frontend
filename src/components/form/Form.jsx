...
// import jsonDetails from "../../../stationtestdata.json";
...
const Form = ({ stationId, onClose, onAddIdol, station }) => {
  ...
  // console.log(motherVillages);

  const [hamletVillages, setHamletVillages] = useState([]);

  const getIdolId = () => {
    // let idolIDs = jsonDetails.stationIdol.map(val => val.idol_id);

    let idolIDs = ["temp12", "temp13", "temp14"];
    let idolID;
    ...
    if (idolIDs.length > 0) {
      ...
      idolID =
        stationId.slice(-6) + "id" + String(maxIdolId + 1).padStart(4, "0");
    } else {
      idolID = stationId.slice(-6) + "id0001";
    }
  ...
  const handleChange = (e) => {
    ...
    if (id === "motherVillage") {
      ...
      setHamletVillages(selectedHamletVillages.map((village) => village.place));
      console.log(hamletVillages);
    }
    if (id === "hamletVillage") {
  ...
  const handleSubmit = (e) => {
    ...
    if (applicantImage) {
      filedata.append("applicantImage", imageFile);
    }
          ...
          {formType === 2 && (
            <div>
              ...
              <div className="form-group row mt-1">
                ...
                {formData.typeOfInstaller === "private" ? (
                  <div className="form-group ">
                    <label htmlFor="startingPoint" className="col-3">
                      Starting Point
                    </label>
                    <input
                      type="text"
                ...
                <div className="form-group ">
                  <label htmlFor="processionRoute" className="col-3">
                    Procession Route
                  </label>
                  <input
                    type="text"
                    name="route"
                    className="form-control col-9"
                    placeholder="Enter procession route"
